...
import { Layers, Loader2, CheckCircle, XCircle, File, Hash, X } from "lucide-react";
                        ...
                        {(item.status === 'review' || item.status === 'issuing' || item.status === 'success' || item.status === 'error') && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="space-y-1 col-span-2">
                                    <label className="text-[10px] text-gray-500 font-mono">Judul</label>
                                    <input
                                ...
                                <div className="space-y-1">
                                    <label className="text-[10px] text-gray-500 font-mono">Pencapaian</label>
                                    <input
                                        disabled={item.status === 'success' || item.status === 'issuing'}
