...
import { CertificateMetadata, CertificateRecord } from '@/lib/types';
import { useSupabase } from '@/lib/supabase/SupabaseProvider';
import { useRouter } from 'next/navigation';
import { extractCertificateDetails } from '@/lib/actions/geminiServices';
import { calculateFileHash, issueCertificateDirect, getRecentCertificates } from '@/lib/actions/blockChainService';
...
const IssuerPage: React.FC = () => {
    ...
    const handleMint = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await issueCertificateDirect(supabase, formData, hash, session.user.id);
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-1">Register new academic credentials on the ledger.</p>
            </div>
